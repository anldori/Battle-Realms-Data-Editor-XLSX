#!/usr/bin/env python3
"""
Battle Realms Data Editor (XLSX)  -  br_editor.py
...
class MainWindow(QMainWindow):
    def __init__(self, path=None):
        ...
        self.book: br_core.BRWorkbook | None = None
    ...
    def open_file(self, path):
        ...
        try:
            self.book = br_core.BRWorkbook(path, progress=prog)
    ...
    def on_about(self):
        QMessageBox.about(
            ...
            'Editor for Battle Realms game data in the newer '
            '<code>.xlsx</code> format that replaced the old '
            '<code>.dat</code> files.<br><br>'
            ...
            'identical and the original formatting is preserved.<br><br>'
